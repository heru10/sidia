<?php
 $sql = "select * from v_berkas_v1 where KurunWaktu BETWEEN '".$_POST['thn1']."' and '".$_POST['thn2']."'
 ...
 $html = '<hr/>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="3">
         ...
         $sdl = "select dokumen_v1.Jumlah, master_satuanarsip.SatuanArsip From dokumen_v1
                 inner join  master_satuanarsip ON master_satuanarsip.SatuanId =   dokumen_v1.SatuanId
