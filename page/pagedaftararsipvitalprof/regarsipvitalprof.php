      ...
      <div class="row">
        <!--<div class="col-md-9">-->
          <div class="box">
            ...
            <hr/>
            <table id="mytbl" class="table table-bordered table-striped" style="display: table-header-group;">
                <thead>
                 <tr class="bg-red">
            ...
            <table class="table" border="0">
               ...
               <tr>
                 ...
                 <td>
                      ...
                      <?php
                          $sql = "SELECT ClId, CONCAT(ClCode,'-',ClName) as KlasName FROM klasifikasi
                                  WHERE CIStatus = 1 AND ClId <> 1";
                          $result = mysqli_query($connect, $sql);
                             while($rows = mysqli_fetch_array($result)){
                               echo "<option value='".$rows['ClId']."'>".$rows['KlasName']."</option>";
                             }
                          ?>
                      </select>
                 </td>
