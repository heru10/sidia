...
<?php
 ...
 if(isset($_GET['ids']))
    $ids = $_GET['ids'];
 if(isset($_GET['pfiler']))
  $Pfiler = $_GET['pfiler'];

  $sql = "select * from detailvitalmetafile_proof where DetVFileId = '".$Pfiler."' ";
  //$sql = "select * from detailvitalmetafile_proof where DetVFileId = '".$Pfiler."'";
        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
             <span class="alert bg-green">&nbsp;</span>
              <div class="box-tools">
            ...
            <!--<form action="tcpdf/print.php" method="post">
                    ...
                    <button type="submit" class="btn btn-warning pull-right"><i class='fa fa-download'></i>&nbsp;Barcode File</button>
            </form><br />-->
            <?php
            ...
            if($Xfile[1]=='jpg' or $Xfile[1]=='jpeg' or $Xfile[1]=='JPG' or $Xfile[1]=='JPEG') { ?>
