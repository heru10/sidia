 ...
 if(file_exists($filepath)){
   ...
   switch($rows['Ket']){
     ...
     case 'b-lampiran'  : $ket = 'Lampiran Dasar Permintaan';
                          break;
     case 'c-nspk'      : $ket = 'Surat Perintah Pekerjaan ';
                          break;
   ...
   $html .= '<td align="center"><button class="btn btn-danger btn-xs" onclick=getviewfile_meta("'.$rows['DetVFileId'].'")><i class="fa fa-file"></i></button></td>';
  }
 }
 $html .= '</tbody>';
 $html .= '</table>';
