        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
             <!--<span class="alert bg-green"><i class="fa fa-street-view fa-1x">&nbsp;<?php echo strtolower($filer[3]);  ?></i></span>--><br /><br />
              <div class="box-tools">

                <button type="button" onclick="pageurl('page/pagedaftardetailvitalproof/daftardetailvitalproof.php?ids=<?php echo $ids; ?>');"  class="btn btn-info pull-right" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
              </div>
            </div>
            ...
            <form action="tcpdf/print.php" method="post">
                    ...
                    <a href="<?php echo $Pfile['Filename']; ?>" download><button type="button" class="btn btn-warning pull-right" onclick='logdok("<?php echo '../'.$Pfile['Filename'];?>","<?php echo $Pfile['KodeReg'];?>")'><i class='fa fa-download'></i>&nbsp;Original File</button></a><br /><br />
            </form><br />
            <?php if($Xfile[1]=='jpg' or $Xfile[1]=='png' or $Xfile[1]=='bmp' or $Xfile[1]=='jpeg') { ?>
