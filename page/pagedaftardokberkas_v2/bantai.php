...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= '<center><i class="text-blue fa fa-folder fa-2x" onclick=list_subberkas("'.$aRow['BerkasId'].'") style="cursor: pointer"></i><span class="label label-danger">'.mysqli_num_rows($resi).'</span></center>';
