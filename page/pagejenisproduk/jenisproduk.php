            ...
            <table id="mytbl" class="table table-bordered table-striped">
                <thead>
                 <tr class="bg-blue">
                  ...
                  <th width="10%"><div align="center">Kategori Produk</div></th>
                  <th width="30%"><div align="center">Nama Dokumen Produk</div></th>
          ...
          <div class="box">
            ...
            <form role="form" name="myfrm" id="myfrm" method="post">
              <div class="form-group">
                <label class="text-red">Kategori Dokumen Produk *</label>
              ...
              <div class="form-group">
                <label class="text-red">Nama Jenis Produk *</label>
                <input type="text" name="txt2" id="txt2" class="form-control" required style="width:40%" />
              </div>
              <div class="form-group">
