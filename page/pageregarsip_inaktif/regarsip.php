<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  <section class="content-header">
      <h3>
        Registrasi Isi Detail Dokumen Inaktif
      </h3>
      <ol class="breadcrumb">
        <li><a href="index2.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Registrasi Isi Detail Dokumen Inaktif</li>
      </ol>
  </section>
                 ...
                 <td>
                    <select class="form-control select4" name="berkas" id="berkas" style="width: 50%;">
                      <option value="">~ Pilih Berkas ~</option>
                       <?php
                           include_once "../../conf.php";
                           $sql = "SELECT klasifikasi.ClCode, berkas.Uraian, berkas.Nomor, berkas.BerkasId FROM berkas
                                   INNER JOIN klasifikasi ON berkas.ClId = klasifikasi.ClId where berkas.RoleId = '".$_SESSION['RoleId']."' and berkas.StatusDok = 'inaktif' ";
                           $result = mysqli_query($connect, $sql);
