            ...
            <div class="box-header with-border">
             <span class="alert bg-green"><i class="fa fa-street-view fa-1x">&nbsp;<?php echo strtolower($filer[3]);  ?></i></span>
              <div class="box-tools">
                ...
                <button type="button" onclick="pageurl('page/pageregarsip/regarsip.php?id=<?php echo $ids; ?>');"  class="btn btn-info pull-right" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
              </div>
            </div>
