<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  <section class="content-header">
      <h3>
        Registrasi Isi Berkas Arsip Aktif
      </h3>
      <ol class="breadcrumb">
        ...
        <!--<div class="col-md-9">-->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Daftar Isi Berkas Arsip Aktif >> <?php echo $xBerkas['Nomor']; ?> - <?php echo $xBerkas['Uraian']; ?></h4>
            </div>
            <div class="box-body">
          ...
          <div class="box">
           ...
           <div id="tblberkas" style="display: none">
            ...
            <div class="box-body pull-left">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn_save"><i class="fa fa-floppy-o"></i><br />Simpan</button>
