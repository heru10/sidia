...
function view_file(id){
  var ids = $("#idx").val();
  pageurl("page/pageregarsip/test_img.php?pfile="+id+"&ids="+ids);
}
...
$(function(e){
   ...
   $("#myfrm").on('submit',(function(e) {
        e.preventDefault();
       var urls = "<?php echo 'page/pageregarsip/regarsip_proses.php'; ?>";
   ...
   function deldata(id){
    ...
    if(tanya){
     ...
     $.ajax({
        ...
        pageurl("page/pageregarsip/regarsip.php?id="+idx);
        }
     })
