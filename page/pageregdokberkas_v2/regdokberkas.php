        ...
        <!--<div class="col-md-9">-->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Daftar Berkas Vital</h4>
            </div>
            <div class="box-body">
            <button type="button" onclick="getdata();" title="Tambah Berkas" class="btn btn-success"><i class="fa fa-database"></i>&nbsp;&nbsp;Tambah Berkas</button>
            <hr/>
...
<!--               <tr id='vretensi' style="display: none">
               ...
               <tr style="display: none">
                  ...
                  <td>
                    ...
                    <input type="text" class="form-control" id="txt5" name="txt5">
                    </div>
                  </td>
               </tr>
               <tr>
