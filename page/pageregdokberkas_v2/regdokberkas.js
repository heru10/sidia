...
function reTable(){
  var table = $('#mytbl').DataTable({
      ...
      'ajax'        : 'page/pageregdokberkas_v2/bantai.php',
      "columns": [
            {
...
function detail_berkas(id){
  //alert(id);
  pageurl("page/pageregarsip_v2/regarsip.php?idb="+id);
}

function addsub_berkas(id){
  pageurl("page/pageregdokberkas_v2/regdoksubberkas.php?idberkas="+id);
