...
session_start();
	 ...
	 */
	$aColumns = array('RegVitalId','KatProdukName','JProdukName','DetailProdukName','Tahun','Kode','Tgl_Reg');
...
//    $row[] .= '<center>'.$aRow['Lokasi_Simpan'].'</center>';
	...
	//7648 | Tri Wibowo, 25/02/2019, jmlitem kelebihan, mungkin harusnya di detail arsip itu hanya yg di jmlitem2
    ...
    $row[] .= '<div align="center"><button type="button" title="Ubah Satuan Naskah" onclick=getload("'.$aRow['RegVitalId'].'"); class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
               <button '.$delbtn.' type="button" title="Hapus Satuan Dokumen" onclick=deldata("'.$aRow['RegVitalId'].'"); class="btn btn-danger btn-sm"><i class="fa fa-bitbucket"></i></button></div>';
    $output['aaData'][] = $row;
