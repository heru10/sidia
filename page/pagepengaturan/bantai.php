...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= ''.$aRow['MediaName'];
    $row[] .= '<div align="center"><button type="button" title="Ubah Tingkat Perkembangan" onclick=getload("'.$aRow['MediaId'].'"); class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
               <button type="button" title="Hapus Tingkat Perkembangan" onclick=deldata("'.$aRow['MediaId'].'"); class="btn btn-danger btn-sm"><i class="fa fa-bitbucket"></i></button></div>';
    $output['aaData'][] = $row;
}
