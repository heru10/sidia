  <?php
    include_once "pengaturan.js";
    include_once "../../conf.php";
  ?>
  <section class="content-header">
      <h3>
        Pengaturan Umum
        <small>Daftar Pengaturan Umum</small>
      </h3>
      <ol class="breadcrumb">
        <li><a href="index2.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Pengaturan Umum</li>
        <li class="active">Pengaturan Lainnya</li>
      </ol>
  </section>
...
<div id="formtable">
      ...
      <div class="row">
          <div class="box">
            ...
            <hr/>
              <table class="table">
                <tr>
                   <td style="width: 25%" class='lead'>Lokasi alih media</td>
                   <td class='lead'>c:/xampp/siarip_peruri</td>
                </tr>
  ...
  <section class="content">
      <div class="row">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Form Media Arsip</h4><hr />
            ...
            <form role="form" name="myfrm" id="myfrm" method="post">
              <div class="form-group">
                <label class="text-red">Media Arsip *</label>
