  <?php
    session_start();
    include_once "regdetailvitalproof.js";
                ...
                <div class="col-md-12">
                  ...
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      ...
                      <!--<li><a href="#tab_2" data-toggle="tab">Uraian Teknis</a></li> heru PDS hide menu ini, 2020-12-10 -->
                          ...
                          <table id="mytbl" class="table table-bordered table-striped">
                            <thead>
                             <tr class="bg-red">
                              ...
                              <th width="10%"><div align="center">Keterangan Pekerjaan</div></th>
							  -->
                   ...
                   <div class="tab-pane" id="tab_1">
                      ...
                      <div class="tab-pane" id="tab_2">
                         ...
                         <?php
                           ...
                           $sql = "select Filename from detailvitalfile_proof where RegVitalId = '".$_REQUEST['ids']."' and Ket = 'ut' ";
                           $result = mysqli_query($connect, $sql);
                      ...
                      <div class="tab-pane" id="tab_3">
                         ...
                         <?php
                           ...
                           $sql = "select Filename from detailvitalfile_proof where RegVitalId = '".$_REQUEST['ids']."' and Ket = 'st' ";
                           $result = mysqli_query($connect, $sql);
                           $test = mysqli_fetch_array($result);
                         ?>
