...
$(function () {
    ...
    $("#lblstatus_masal").html("Status : Tambah Dokumen Vital");
    $("#task").val("new");
    $("#task_masal").val("new");
...
$(function(e){
   $("#myfrm_masal").on('submit',(function(e) {
        e.preventDefault();
       var urls = "<?php echo 'page/pageregdokberkas_v1/regdokberkas_proses.php'; ?>";
...
//untuk insert tambah berkas dan sub berkas 
  function getdata_masal(){
    closetable_masal();
    $("#txt1_masal").val('');
    $("#txt1_masal").focus();
   }
   
   function closetable_masal(){
    $("#forminput_masal").show(1000);
    $("#formtable").hide(1000);
   }
