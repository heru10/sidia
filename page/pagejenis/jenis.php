      ...
      <div class="row">
        <!--<div class="col-md-9">-->
          <div class="box">
            ...
            <div class="box-body">
            <button type="button" onclick="getdata();" title="Tambah Jenis Dokumen" class="btn btn-success"><i class="fa fa-database"></i>&nbsp;&nbsp;Tambah Jenis Dokumen</button>
            <hr/>
            <table id="mytbl" class="table table-bordered table-striped">
                <thead>
                 <tr class="bg-blue">
                  <th width="5%"><div align="center">No.</div></th>
                  <th width="80%"><div align="center">Jenis Dokumen</div></th>
          ...
          <div class="box">
            ...
            <form role="form" name="myfrm" id="myfrm" method="post">
              <div class="form-group">
                <label class="text-red">Jenis Dokumen *</label>
