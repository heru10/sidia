  <?php
    session_start();
    include_once "daftardetailvitaldalitas.js";
                   ...
                   <div class="tab-pane active" id="tab_1">
                      ...
                      <div class="tab-pane" id="tab_2">
                         ...
                         <?php
                           ...
                           $sql = "select Filename, KodeReg from detailvitalfile where RegVitalId = '".$_REQUEST['ids']."' and Ket = 'ut' ";
                           $result = mysqli_query($connect, $sql);
                              ...
                              <br />
                                <h4 class="box-title"><span style=" padding: 10px" class='bg-info'><?php echo "Lokasi simpan : ".$lokUT['Lokasi']; ?></span></h4><br />
                                 <form action="tcpdf/print.php" method="post">
                                    ...
                                    <a href="<?php echo $test['Filename']; ?>" download><button type="button" class="btn btn-warning pull-right" onclick='logdok("<?php echo $test['Filename'];?>","<?php echo $test['KodeReg'];?>")'><i class='fa fa-download'></i>&nbsp;Original File</button></a>
                                </form>
                                <br /><br />
                            </div>
                               <center>
                      ...
                      <div class="tab-pane" id="tab_3">
                         ...
                         <?php
                           ...
                           $sql = "select Filename, KodeReg from detailvitalfile where RegVitalId = '".$_REQUEST['ids']."' and Ket = 'st' ";
                           $result = mysqli_query($connect, $sql);
                           $test = mysqli_fetch_array($result);
                         ?>
                         ...
                         ?>
                            ...
                            <div class="box-header with-border">
                              <br />
                               ...
                               <h4>Keterangan : <?php if(empty($lokPL['Keterangan'])) echo "-"; else echo $lokPL['Keterangan']; ?></h4>
                                <?php
                                 $sql = "select DetVFileId, Filename, Size, KodeReg from detailvitalfile where RegVitalId = '".$_REQUEST['ids']."' and Ket = 'pl' ";
                                 $result = mysqli_query($connect, $sql);
                                 $test = mysqli_num_rows($result);
                                  ...
                                  while($data=mysqli_fetch_array($result)){
                                       ...
                                       if($true)
                                         ...
                                         <!--<form action="tcpdf/print.php" method="post">
                                            ...
                                            <input type="hidden" name="code" value="<?php echo $data['KodeReg']; ?>" >
                                            <button type="submit" class="btn btn-success pull-right"><i class='fa fa-download'></i>&nbsp;Barcode File</button>
                                            <a href="<?php echo $data['Filename']; ?>" download><button type="button" class="btn btn-warning pull-right" onclick='logdok("<?php echo $test['Filename'];?>","<?php echo $test['KodeReg'];?>")'><i class='fa fa-download'></i>&nbsp;Original File</button></a>
                                        </form>-->
                                         </center></td>
