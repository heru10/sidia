        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
             ...
             <button type="button" onclick="pageurl('page/pagedaftardetailvitaldalitas/daftardetailvitaldalitas.php?ids=<?php echo $ids; ?>');"  class="btn btn-info" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
            </div>
            <div class="box-body">
               <form action="tcpdf/print.php" method="post">
                   ...
                   <button type="submit" class="btn btn-success pull-right" onclick='logdok("<?php echo '../'.$Pfile['Filename'];?>","<?php echo $Pfile['KodeReg'];?>")'><i class='fa fa-download'></i>&nbsp;Barcode File</button>
