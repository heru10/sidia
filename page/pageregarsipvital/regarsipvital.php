<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  <?php
  session_start();
    include_once "regarsipvital.js";
    include_once "../../conf.php";
    $codreg = code("MV-",15);
    //unset($_SESSION['CodeRole']);
  ?>
  <style type="text/css">
  /*<![CDATA[*/
   tfoot {
  ...
  <section class="content-header">
      <h3>
        Dokumen Vital <?php echo $_SESSION['RoleName']; ?>
      </h3>
    <!--  <h5>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Registrasi Dokumen Vital</li>
      </ol>
  </section>
      ...
      <div class="row">
        <!--<div class="col-md-9">-->
          <div class="box">
            ...
            <hr/>
            <table id="mytbl" width="100%" class="table table-bordered table-striped" style="display: table-header-group;">
                <thead>
                 <tr class="bg-red">
                  <th width="3%"><div align="center">No.</div></th>
                  <th width="20%"><div align="center">Kategori Produk1</div></th>
                  <th width="20%"><div align="center">Produk</div></th>
                  <th width="20%"><div align="center">Detail Produk</div></th>
                  <th width="10%"><div align="center">Tahun</div></th>
                  <th width="10%"><div align="center">Input Detail</div></th>
          ...
          <div class="box">
           ...
           <div class="box-body">
            <table class="table" border="0">
                 ...
                 <td>
                      <select class="form-control select2" onchange="load_txt1();" id="txt1" name="txt1" style="width: 30%" required >
                        <option value="">- Pilih Kategori Produk -</option>
                         <?php
                          $sql = "select KatProdukId, KatProdukName from master_katproduk where StatusAct = '1' ";
               ...
               <tr>
                 <td width="20%"><b class="text-red">Nama Produk</b></td>
                 <td>
               ...
               <!--<tr style="display: none">
                  ...
                  <td>
                    <select class="form-control select4" id="txt7" name="txt7" style="width: 50%" required>
                      ...
                      <?php
                          $sql = "select KodeId, Uraian from master_kodekerja";
                          $result = mysqli_query($connect, $sql);
                          if(mysqli_num_rows($result)>1){
                             while($row=mysqli_fetch_array($result)){
                               echo "<option value='".$row['KodeId']."'>".$row['Uraian']."</option>";
                             }
                          }
                      ?>
                      </select>
               ...
               <tr>
                  <td><b class="text-red">Jumlah</b></td>
                  <td>
                    <div class="input-group input-group-sm col-md-2">
                    <input type="text" class="form-control" id="txt12" name="txt12" required>
