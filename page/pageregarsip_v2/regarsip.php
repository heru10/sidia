<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  <section class="content-header">
      <h3>
        Registrasi Isi Berkas Arsip
      </h3>
      <ol class="breadcrumb">
        <li><a href="index2.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Registrasi Isi Berkas Arsip Vital</li>
      </ol>
  </section>
      ...
      <div class="row">
        <!--<div class="col-md-9">-->
          <div class="box">
            ...
            <button type="button" onclick="getdata();" title="Tambah Isi Berkas" class="btn btn-success"><i class="fa fa-database"></i>&nbsp;&nbsp;Tambah Isi Berkas</button>
          ...
          <div class="box">
           ...
           <div id="tblberkas" style="display: none">
                 ...
                 <td>
                    <select class="form-control select4" name="berkas" id="berkas" style="width: 50%;">
                      <option value="">~ Pilih Pindah Berkas ~</option>
                       <?php
                           include_once "../../conf.php";
                           $sql = "SELECT klasifikasi.ClCode, berkas_v2.Uraian, berkas_v2.Nomor, berkas_v2.BerkasId FROM berkas_v2
                                   INNER JOIN klasifikasi ON berkas_v2.ClId = klasifikasi.ClId where berkas_v2.RoleId = '".$_SESSION['RoleId']."' ";
                           $result = mysqli_query($connect, $sql);
            ...
            <div class="box-body pull-left">
                    ...
                    <input type="hidden" name="idx" id="idx" value="<?php echo $idx; ?>"  /> <!-- idberkas -->
                    <input type="hidden" name="idberkas" id="idberkas" value="<?php echo $idberkas; ?>"  /> <!-- idberkas -->
