          ...
          <div class="box box-solid">
            <div class="box-header with-border">
             <span class="alert bg-green"><i class="fa fa-street-view fa-1x">&nbsp;<?php echo strtolower($filer[3]);  ?></i></span>
              <div class="box-tools">
                ...
                <button type="button" onclick="pageurl('page/pagedaftararsip_aktif/regarsip.php?id=<?php echo $ids; ?>');"  class="btn btn-info pull-right" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
              </div>
            </div>
            ...
            <?php } else { ?>
                <!--<input id="zoomslider" class="zoomslider" type="range" min="0" max="100.00" step="1" ng-model="selectedRange">-->
                  ...
                  <object id="viewST" data="ViewerJS2/#../<?php echo $Pfilex; ?>" type = "application/pdf"  width="100%" height="700" >
                  </object>
               <?php } ?>
            </div>
          </div>
