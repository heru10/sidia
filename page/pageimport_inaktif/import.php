  ...
  <section class="content">
      <div class="row">
          <div class="box">
            ...
            <div class="box-body">
             <a href="page/pageimport_inaktif/form_inaktif.xls" download><button class='btn btn-info'>Unduh Table Template (.xls)</button></a>
            <hr/>
            <form role="form" name="myfrm" id="myfrm" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label class="text-red">Upload Dokumen Inaktif <small>(.xls)</small></label>
