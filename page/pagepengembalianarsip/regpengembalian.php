  <?php
    session_start();
    include_once "regpengembalian.js";
        ...
        <!--<div class="col-md-9">-->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Pengembalian Dokumen Fisik</h4>
            </div>
            <div class="box-body">
            <!--<button type="button" onclick="getdata();" title="Cetak Daftar Pinjam" class="btn btn-success"><i class="fa fa-database"></i>&nbsp;&nbsp;Cetak</button>-->
            ...
            <table id="mytbl" class="table table-bordered table-striped">
                <thead>
                 <tr class="bg-red">
                  ...
                  <th width="20%"><div align="center">Judul Dokumen / Berkas</div></th>
                  <th width="10%"><div align="center">Tanggal Pinjam</div></th>
                  <th width="10%"><div align="center">Tanggal Kembali</div></th>
                  <th width="15%"><div align="center">Detail Peminjam</div></th>
                  <th width="15%"><div align="center">Detail Pengembalian</div></th>
                  <th width="5%"><div align="center">Status Pinjam</div></th>
                 </tr>
                </thead>
                <tfoot class="bg-info">
                    <tr >
...
<!--  <div id="forminput" style="display: none">
  <section class="content">
      ...
      <form role="form" name="myfrm" id="myfrm" method="post" enctype="multipart/form-data">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Form Permohonan Peminjaman Dokumen Fisik</h4><hr />
           ...
           <div class="box-body">
            <table class="table" border="0">
               ...
               <tr>
                  <td width="20%"><b class="text-red">NIP</b></td>
                  <td>
               ...
               <tr>
                  ...
                  <td>
                     <input type="file" name="myfiles" id="myfiles" onchange="getupload();" required /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <input type='hidden' id='idp' name='idp' class="text-black" />
        <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
        <button type="button" id="btn_simpan" class="btn btn-outline" onclick=getkembali();>Simpan</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
