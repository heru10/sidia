...
function view_file(id){
  var ids = $("#idx").val();
  pageurl("page/pagedaftararsip_aktif/test_img.php?pfile="+id+"&ids="+ids);
}
...
function reTable(){
  ...
  var table = $('#mytbl').DataTable({
      ...
      'ajax'        : 'page/pagedaftararsip_aktif/bantai.php?idx='+id,
      "columns": [
            {
   ...
   function backpage(){
     pageurl("page/pagedaftarberkas_aktif/regdokberkas.php");
   }
</script>