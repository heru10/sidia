        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
             ...
             <button type="button" onclick="pageurl('page/pagedaftararsip_aktif/regarsip.php?id=<?php echo $ids; ?>');"  class="btn btn-info" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
            </div>
            <div class="box-body">
