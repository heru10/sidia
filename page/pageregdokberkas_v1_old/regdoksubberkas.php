<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  session_start();
    ...
    if(isset($_GET['id'])){
    $sql = "select Ur from v_berkas_v1 where BerkasId = '".$_GET['id']."' ";
      ...
      <div class="row">
        <!--<div class="col-md-9">-->
          <div class="box">
            ...
            <div class="box-body">
            <button type="button" onclick="getdata();" title="Add Document" class="btn btn-success"><i class="fa fa-database"></i>&nbsp;&nbsp;Tambah Sub Berkas</button>
            <button type="button" onclick="closed();" title="Kembali" class="btn btn-default"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</button>
            <hr/>
  ...
  <div class="box-body" id="formdetail" style="display: none">
      <div class="box-header with-border">
        <h4 class="box-title">Detail Information Dokumen Vital</h4>
      </div>
...
<!--               <tr id='vretensi' style="display: none">
               ...
               <tr id='tr_nip'>
                  <td><b class="text-red">NIP/NP</b></td>
                  <td>
                     <input type="text" name="txtnip" id="txtnip" class="form-control" style="width:100%" <?php if($_GET['req']!='sub') echo "required";  ?>  />
                  </td>
               </tr>
               <tr id='tr_nama'>
                  <td><b class="text-red">Nama Karyawan</b></td>
                  <td>
                     <input type="text" name="txt3" id="txt3" class="form-control" style="width:100%" <?php if($_GET['req']!='sub') echo "required";  ?> />
                  </td>
               </tr>
               <tr id='tr_nberkas'>
                  <td><b class="text-red">Nama Berkas</b></td>
                  <td>
                     <input type="text" name="txt3A" id="txt3A" class="form-control" style="width:100%" <?php if($_GET['req']=='sub') echo "required";  ?> />
                  </td>
               </tr>
            ...
            <div class="box-body pull-left">
                    ...
                    <button type="button"  onclick="closed2();" class="btn btn-default"><i class="fa fa-remove"></i><br />Close</button>
              </div>
            </div>
           </div>
        </div>
