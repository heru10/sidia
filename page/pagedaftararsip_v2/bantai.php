...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= ''.$aRow['Uraian'];
    //$row[] .= '<div align="center"><button type="button" title="Ubah Naskah" onclick=getload("'.$aRow['DokumenId'].'"); class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
    //           <button type="button" title="Hapus Naskah" onclick=deldata("'.$aRow['DokumenId'].'"); class="btn btn-danger btn-sm"><i class="fa fa-bitbucket"></i></button></div>';
    $output['aaData'][] = $row;
