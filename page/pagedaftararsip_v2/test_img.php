...
<?php
 ...
 if(isset($_REQUEST['pfile']))
  ...
  $sql = "select Filename, KodeReg from filesdigital_v2 where FilesId = '".$Pfile."' ";
        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <div class="box-tools">
                <button type="button" onclick="pageurl('page/pagedaftararsip_v2/daftararsip.php?idb=<?php echo $idb; ?>&idsb=<?php echo $idsb; ?>&req=<?php echo $req; ?>');"  class="btn btn-info pull-right" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
              </div>
            </div>
