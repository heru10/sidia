  ...
  <section class="content">
      ...
      <form role="form" name="myfrm" id="myfrm" method="post" enctype="multipart/form-data">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Form Permohonan Peminjaman Dokumen</h4><hr />
           ...
           <div class="box-body">
            <table class="table" border="0">
               ...
               <tr>
                  <td width="20%"><b class="text-red">Tujuan Permohonan</b></td>
                  <td>
               ...
               <tr>
                  ...
                  <td>
                     <select class="form-control" id="txt5" name="txt5" style="width: 50%" required >
                         ...
                         <option value="m3" id="m3" style="display: none"> Dokumen Vital Setkol</option>
                     </select>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  <td width="20%"><b class="text-red">Uraian Peminjaman</b></td>
                  <td>
