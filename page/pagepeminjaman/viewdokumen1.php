<?php
   ...
   $sql = "select * from v_naskah_vital where RegVitalId = '".$id."'  ";
   $result = mysqli_query($connect, $sql);
                        ...
                        <div class="box-group" id="accordion">
                          ...
                          <div class="panel box box-primary" style="display:<?php echo $vut; ?>">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse">
                              <div class="box-body">
                                <center>
                                    <?php
                                     $sql = "select Filename, KodeReg from detailvitalfile where RegVitalId = '".$id."' and Ket = 'ut' ";
                                     $result = mysqli_query($connect, $sql);
                          ...
                          <div class="panel box box-danger" style="display:<?php echo $vst; ?>">
                            ...
                            <div id="collapseTree" class="panel-collapse collapse">
                              <div class="box-body">
                                  <center>
                                    <?php
                                     $sql = "select Filename, KodeReg from detailvitalfile where RegVitalId = '".$id."' and Ket = 'st' ";
                                     $result = mysqli_query($connect, $sql);
                                     $test = mysqli_fetch_array($result);
                                     ?>
                                      <form style="display: <?php echo $btndownload; ?>" action="tcpdf/print.php" method="post">
                          ...
                          <div class="panel box box-success" style="display:<?php echo $vpl; ?>">
                            ...
                            <div id="collapseFour" class="panel-collapse collapse">
                              <div class="box-body">
                                 <?php
                                 $sql = "select DetVFileId, Filename, Size from detailvitalfile where RegVitalId = '".$id."' and Ket = 'pl' ";
                                 $result = mysqli_query($connect, $sql);
                                 $test = mysqli_num_rows($result);
