<?php
   ...
   $sql = "select * from v_berkas_inaktif where BerkasId = '".$id."'  ";
   $result = mysqli_query($connect, $sql);
  ...
  /*]]>*/
              ...
              <div class="box-body">
                ...
                <table class='table no-border'>
                  <tr>
                    ...
                    <td>:&nbsp;<b><?php echo $uraian[0]; ?></b></td>
                  </tr>
                  <tr>
                    <td>Judul Berkas</td>
                    <td>:&nbsp;<b><?php echo $uraian[1]; ?></b></td>
                  </tr>
                </table>
                <br />
    ...
    // `d` is the original data object for the row
        //alert(d);
          ...
          var shtml = $.ajax({
          type: "POST",
          url: "page/pagepeminjaman/inaktif/detail.php?id="+d+"&idx="+idx,
      ...
      function reTable(){
       ...
       var table = $('#mytbl').DataTable({
          ...
          'ajax'        : 'page/pagepeminjaman/inaktif/bantai6.php?idx='+id,
          "columns": [
                { "aaData": "0" },
                { "aaData": "1" },
                { "aaData": "2" },
