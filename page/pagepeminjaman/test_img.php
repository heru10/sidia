...
<?php
 ...
 if($ket=="m0"){
  ...
  $sql = "select * from detailvitalmetafile_proof where DetVFileId = '".$Pfile."' ";
  $m1 = "inline";
 }
 ...
 <div class="row">
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
             <span class="alert bg-green"><i class="fa fa-street-view fa-1x">&nbsp;<?php echo strtolower($filer[3]);  ?></i></span>
              ...
              <div class="box-tools">
				...
				<!--Tri Wibowo 7648, 19 11 2019, Matikan kembali dengan metode M0, karena error 
				...
				-->
				<!--Tri Wibowo 7648, 19 11 2019, walaupun M0 / M1 tetap memakai tombol kembali ini -->
                <button type="button" style="display: <?php echo $m1; ?>  <?php echo $m0; ?>" onclick="pageurl('page/pagepeminjaman/viewdokumen2.php?id=<?php echo $ids; ?>&idx=<?php echo $idx; ?>');"  class="btn btn-info pull-right" data-widget="collapse"><i class="fa fa-mail-reply"></i>
                  &nbsp; Kembali&nbsp;
                </button>
              </div>
            </div>
			...
			<!--Tri Wibowo 7648, 19 11 2019, menambahkan jpeg -->
            <?php if($Xfile[1]=='jpg' || $Xfile[1]=='jpeg') { ?>
