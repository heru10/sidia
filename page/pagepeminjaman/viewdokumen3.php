<?php
   ...
   $sql = "select * from v_berkas_aktif where BerkasId = '".$id."'  ";
   $result = mysqli_query($connect, $sql);
  ...
  /*]]>*/
    ...
    // `d` is the original data object for the row
        //alert(d);
          ...
          var shtml = $.ajax({
          type: "POST",
          url: "page/pagepeminjaman/aktif/detail.php?id="+d+"&idx="+idx,
      ...
      function reTable(){
       ...
       var table = $('#mytbl').DataTable({
          ...
          'ajax'        : 'page/pagepeminjaman/aktif/bantai6.php?idx='+id,
          "columns": [
                { "aaData": "0" },
                { "aaData": "1" },
                { "aaData": "2" },
