...
function reTableDaftarvital(){
  ...
  switch(ka){
    case "m0" : if(task=='edit')
                urls = 'page/pagepeminjaman/bantai3.php?role='+role+'&idx='+idx+'&idi='+idi;
                else
                urls = 'page/pagepeminjaman/bantai3.php?role='+role;

                $("#tbldok").show();
                break;
    case "m1" : if(task=='edit')
                urls = 'page/pagepeminjaman/bantai2.php?role='+role+'&idx='+idx+'&idi='+idi;
                else
                urls = 'page/pagepeminjaman/bantai2.php?role='+role;
                $("#tbldok").show();
                break;
    case "m2" : if(task=='edit')
                urls = 'page/pagepeminjaman/bantai4.php?role='+role+'&ka='+ka+'&idx='+idx;
                else
                urls = 'page/pagepeminjaman/bantai4.php?role='+role;
                $("#tbldok").show();
                break;
    case "m3" : if(task=='edit')
                urls = 'page/pagepeminjaman/bantai5.php?role='+role+'&ka='+ka+'&idx='+idx;
                else
                urls = 'page/pagepeminjaman/bantai5.php?role='+role;
                $("#tbldok").show();
                break;
    case "m4" : if(task=='edit')
                urls = 'page/pagepeminjaman/bantai1.php?role='+role+'&ka='+ka+'&idx='+idx;
                else
                urls = 'page/pagepeminjaman/bantai1.php?role='+role+'&ka='+ka;
                $("#tbldok").show();
                break;
    case "m5" : if(task=='edit')
                urls = 'page/pagepeminjaman/bantai1.php?role='+role+'&ka='+ka+'&idx='+idx;
                else
                urls = 'page/pagepeminjaman/bantai1.php?role='+role;
                $("#tbldok").show();
