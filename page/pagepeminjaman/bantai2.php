...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= '<strong>'.$aRow['KatProdukName'].' >> '.$aRow['JProdukName'].' >> '.$aRow['DetailProdukName'].'</strong><br />
              <label><input type="checkbox" '.$chksp.' name="chks['.$aRow['RegVitalId'].'][]" id="chks" value="sp">&nbsp;Spesimen</label>&nbsp;
              <label><input type="checkbox" '.$chkut.' name="chks['.$aRow['RegVitalId'].'][]" id="chks" value="ut">&nbsp;Uraian Teknis</label>&nbsp;
              <label><input type="checkbox" '.$chkst.' name="chks['.$aRow['RegVitalId'].'][]" id="chks" value="st">&nbsp;Spesifikasi Teknis</label>&nbsp;
              <label><input type="checkbox" '.$chkpl.' name="chks['.$aRow['RegVitalId'].'][]" id="chks" value="pl">&nbsp;Dokumen Pendukung</label>&nbsp;
              <label><input type="checkbox" '.$chkmd.' name="chks['.$aRow['RegVitalId'].'][]" id="chks" value="md">&nbsp;Metadata</label>';
