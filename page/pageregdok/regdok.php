<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  <section class="content-header">
      <h3>
        Manajemen Dokumen Aktif <?php echo $_SESSION['RoleName']; ?>
      </h3>
      <ol class="breadcrumb">
        <li><a href="index2.html"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manajemen Dokumen Aktif</li>
      </ol>
  </section>
        ...
        <!--<div class="col-md-9">-->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Daftar Dokumen Aktif</h4>
            </div>
            <div class="box-body">
            ...
            <table id="mytbl" class="table table-bordered table-striped">
                <thead>
                 <tr class="bg-red">
                  ...
                  <th width="15%"><div align="center">Klasifikasi Dokumen</div></th>
                  <th width="12%"><div align="center">Nomor / Tgl. Dokumen</div></th>
  ...
  <section class="content">
      ...
      <form role="form" name="myfrm" id="myfrm" method="post" enctype="multipart/form-data">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Form Registrasi Dokumen Aktif</h4><hr />
            ...
            <div class="box-body">
              ...
              <span class="pull-right">
                <label><?php date('d/m/Y')." - ". $_SESSION['PeopleName']; ?> - Agus Haryono</label>
              </span><br />
              <hr/>
           <div class="box-body">
            <table class="table" border="0">
               <tr>
                 <td width="20%"><b class="text-red">Tanggal Dokumen</b></td>
                 <td>
               ...
               <tr>
                  <td><b class="text-red">Klasifikasi Dokumen</b></td>
                  <td>
                     <select class="form-control select2" name="txt2" id="txt2" style="width: 50%;" required>
                      <option value="">~ Pilih Klasifikasi Dokumen ~</option>
                       <?php
                           include_once "../../conf.php";
                           $sql = "select ClId, concat(ClCode,' - ',ClName) as ClKlas from klasifikasi where ClCode != 'SK'";
                           $result = mysqli_query($connect, $sql);
                           while($row=mysqli_fetch_array($result)){
                             echo "<option value='".$row['ClId']."'>".$row['ClKlas']."</option>";
                           }
                        ?>
                    </select>
                  </td>
               ...
               <tr>
                  ...
                  <td>
                    <input type="text" name="txt3" id="txt3" class="form-control" style="width: 40%"  required />
                  </td>
               </tr>
               <tr>
                  <td><b class="text-red">Unit Kerja Pemilik Dokumen</b></td>
                  <td>
                    <input type="hidden" id="txt4a" name="txt4a" />
               ...
               <tr>
                  <td><b class="text-red">Jenis Dokumen</b></td>
                  <td>
                    <select class="form-control select5" name="txt5" id="txt5" style="width: 30%;" required>
               ...
               <tr>
                  ...
                  <td>
                     <textarea class="form-control" id="txt6" name="txt6" style="width:50%"></textarea>
                  </td>
               </tr>
               <tr>
                  ...
                  <td>
                    ...
                    <div class="input-group-btn">
                      <select class="btn btn-warning dropdown-toggle" id="txt8" name="txt8" >
                      <?php
               ...
               <tr>
                  ...
                  <td>
                    <select class="form-control select3" id="txt9" name="txt9" style="width: 50%" >
                      <?php
               ...
               <tr>
                 <td>Tesaurus</td>
                 <td>
                   <input type="text" name="txt13" id="txt13" class="form-control" />
