<?php
 ...
 if($task=='new'){
   ...
   if($_SESSION['RoleId']!='UK')
    ...
    $sql = "select MAX(Nomor) + 1 as Nb ";
    $sql .= "from berkas where RoleId = '".$RoleId."' and StatusDok = 'aktif' ";
    ...
    $pathDB = "Upload_Files/".$subf[0]."/dok_".vnomorberkas($nb)."/";
    $path = "../../Upload_Files/".$subf[0]."/dok_".vnomorberkas($nb)."/";
    ...
    $sql .= "(BerkasId, KodeReg, IntNomor, Nomor, ClId, RetensiInAktif, RoleId, Uraian, KurunWaktu, Jumlah, TPId,
