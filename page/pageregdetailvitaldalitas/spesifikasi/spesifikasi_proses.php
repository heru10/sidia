<?php
 ...
 if($task=='edit'){
  try{
    ...
    $sql = "Select DetVFileId, Filename from detailvitalfile where RegVitalId ='".$ids."' and Ket = 'st' ";
    $result = mysqli_query($connect, $sql);
    $data=mysqli_fetch_array($result);
      $target_file = "../../../".$data['Filename'];
      if (unlink($target_file)){
            $sql = "DELETE FROM detailvitalfile WHERE RegVitalId= '".$_REQUEST['ids']."' and Ket = 'st' ";
