...
function fileExists(url) {
  ...
  $(function(e){
   $("#mymetadata").on('submit',(function(e) {
        e.preventDefault();
       var urls = "<?php echo 'page/pageregdetailvitaldalitas/uraian/uraian_proses.php'; ?>";
...
function getload_ut(){
  ...
  var ids = $("#ids").val();
    ...
    $.ajax({
        url: "page/pageregdetailvitaldalitas/uraian/uraian_proses.php", // Url to which the request is send
        type: "POST",
