  ...
  session_start();
    ...
    {
     $id = $_REQUEST['id'];
     echo $sql = "select Filename from detailvitalfile where DetVFileId = '".$id."' limit 1 ";
     $result = mysqli_query($connect, $sql);
  ...
  <section class="content-header">
      <h4>
        Detail <b class="text-blue">Pendukung</b> Dokumen Vital
      </h4>
            ...
            <div class="box-body">
              ...
              <form role="form" name="mymetadata" id="mymetadata" method="post" enctype="multipart/form-data" >
                 ...
                 <table class="table" border="0">
                    <tr>
                       <td width="15%"><b>Upload File</b> <br /></td>
                       <td>
                           <input type="file" onchange="getupload('pl');"  id="txtfpl" name="txtfpl[]" multiple>
                           <input type="hidden" id="jmlfile_pl" value="0" /><br />
                       ...
                       <tr>
                          ...
                          <td><input type="text" id='txt5' name='txt5' class='form-control' style=" width: 80%" /></td>
                       </tr>
                       <tr>
