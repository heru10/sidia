...
session_start();
	 ...
	 */
	$aColumns = array( 'SatuanId', 'SatuanArsip');

//	$aColumns = array( 'NId', 'NTipe', 'StatusReceive', 'Nomor', 'Hal', 'Tgl', 'InstansiPengirim' );

	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "SatuanId";

	/* DB table to use */
	$sTable = "master_satuanarsip";
...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= ''.$aRow['SatuanArsip'];
    $row[] .= '<div align="center"><button type="button" title="Ubah Satuan Naskah" onclick=getload("'.$aRow['SatuanId'].'"); class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
               <button type="button" title="Hapus Satuan Naskah" onclick=deldata("'.$aRow['SatuanId'].'"); class="btn btn-danger btn-sm"><i class="fa fa-bitbucket"></i></button></div>';
    $output['aaData'][] = $row;
}
