<script src="bower_components/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
  ...
  <?php
  session_start();
    include_once "regarsipvitaldalitas.js";
    include_once "../../conf.php";
    $codreg = code("dalitas-",5);
            ...
            <table id="mytbl" class="table table-bordered table-striped">
                <thead>
                 <tr class="bg-red">
                  ...
                  <th width="5%"><div align="center">Keterangan</div></th>
                 ...
                 <td>
                      <select class="form-control select2" onchange="load_txt1();" id="txt1" name="txt1" style="width: 30%" required >
                        <option value="">- Pilih Kategori Produk -</option>
                         <?php
                          $sql = "select KatProdukId, KatProdukName from master_katproduk where StatusAct = '1' and RoleId like '".$_SESSION['RoleParentId']."%' ";
