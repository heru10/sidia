...
function load_txt1(idjp){
   var id = $("#txt1").val();
    $.ajax({
      url  : 'page/pageregarsipvitaldalitas/regarsipvitaldalitas_proses.php',
...
function reTable(){
  var table = $('#mytbl').DataTable({
      ...
      'ajax'        : 'page/pageregarsipvitaldalitas/bantai.php',
      'oLanguage': {
				"sSearch": "Pencarian :",
		}
    });
...
$(function(e){
   $("#myfrm").on('submit',(function(e) {
        e.preventDefault();
       var urls = "<?php echo 'page/pageregarsipvitaldalitas/regarsipvitaldalitas_proses.php'; ?>";
       $.ajax({
   ...
   function getload(id){
    $.ajax({
        url: "page/pageregarsipvitaldalitas/regarsipvitaldalitas_proses.php", // Url to which the request is send
        type: "POST",
