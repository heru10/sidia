        ...
        <!--<div class="col-md-9">-->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">Daftar Isi Berkas Arsip Vital >> <?php echo $xBerkas['Nomor']." >> ".$xBerkas['Uraian'] ?></h4>
            </div>
            <div class="box-body">
           ...
           <div id="tblberkas" style="display: none">
                 ...
                 <td>
                    <select class="form-control select4" name="berkas" id="berkas" style="width: 50%;">
                      <option value="">~ Pilih Pindah Berkas ~</option>
                       <?php
                           include_once "../../conf.php";
                           $sql = "SELECT klasifikasi.ClCode, berkas_v1.Uraian, berkas_v1.Nomor, berkas_v1.BerkasId FROM berkas_v1
            ...
            <table class="table" border="0">
               ...
               <tr style="display:none">
                  ...
                  <td>
                     <select class="form-control select3" name="txt2" id="txt2" style="width: 30%;">
