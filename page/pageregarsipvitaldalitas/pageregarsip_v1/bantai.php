...
//	$aColumns = array( 'NId', 'NTipe', 'StatusReceive', 'Nomor', 'Hal', 'Tgl', 'InstansiPengirim' );
	...
	$sQuery = "
		...
		FROM   $sTable Where BerkasId = '".$_GET['idx']."'
	";
...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= ''.$aRow['Uraian'];
    $row[] .= '<div align="center"><button type="button" title="Ubah Satuan Naskah" onclick=getload("'.$aRow['DokumenId'].'"); class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
               <button type="button" title="Hapus Satuan Dokumen" onclick=deldata("'.$aRow['DokumenId'].'"); class="btn btn-danger btn-sm"><i class="fa fa-bitbucket"></i></button></div>';
    $output['aaData'][] = $row;
