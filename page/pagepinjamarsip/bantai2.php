...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $sql = "select ArsipPinjam from v_peminjaman_fisik where Keterangan = 'm1' and StatusPinjam = '1'   ";
...
//function cekpinjam($Bid){
//  $kondisi = 'true';
//  $sql = "select ArsipPinjam from v_peminjaman_fisik where Keterangan = 'm1' and StatusPinjam = '1'   ";
//  $result = mysqli_query($connect, $sql);
//  while($data=mysqli_fetch_array($result)){
//     $GetId = explode("|",$data['ArsipPinjam']);
//     foreach($GetId as $RId){
//       if($RId==$BId)
