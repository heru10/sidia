...
session_start();
	 ...
	 */
	$aColumns = array('PeminjamanId', 'TglPinjam', 'Nip','Nama','UnitKerja', 'Catatan','Filename', 'TglReg', 'Keterangan', 'StatusPinjam');
...
while($aRow = mysqli_fetch_array($rResult)){
    ...
    $row[] .= '<center><button type="button" title="Ubah Data" onclick=getload("'.$aRow['PeminjamanId'].'"); class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button>
                <button type="button" title="Hapus Satuan Dokumen" onclick=deldata("'.$aRow['PeminjamanId'].'"); class="btn btn-danger btn-sm"><i class="fa fa-bitbucket"></i></button></center>';
    }else $row[] .= "<center class='text-blue'>Transaksi Selesai</center>";
    $output['aaData'][] = $row;
