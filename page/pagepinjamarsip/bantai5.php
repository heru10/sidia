...
session_start();
	 ...
	 */
	$aColumns = array('BerkasId','Ur','KurunWaktu','SubBerkas');
...
//       $uraian .= '/'.$aRow['Nip'].'';
//
//    $uraian .= ''.$aRow['Uraian'].''.$subberkas.'';
    $row[] .= ''.$aRow['Ur'].''.$subberkas;
...
//    $sql = "select ArsipPinjam from v_peminjaman_fisik where Keterangan = 'm3' and StatusPinjam = '1'   ";
