...
//
 if($task=='del'){
  try{
    $sql = "select Filename From peminjaman_fisik where PeminjamanId = '".$id."' ";
 ...
 if($task=='back'){
   $id = $_REQUEST['id'];
   $sql = "update peminjaman_fisik set StatusPinjam = 0 where PeminjamanId = '".$id."' ";
