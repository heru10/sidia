  ...
  <section class="content-header">
      <h4>
        Detail <b class="text-blue">Spesimen</b> Dokumen Vital
      </h4>
            ...
            <div class="box-body">
              ...
              <form role="form" name="mymetadata" id="mymetadata" method="post" enctype="multipart/form-data" >
                 ...
                 <table class="table" border="0">
                    <tr>
                       <td width="15%">Upload File <br /><small class="text-red">* Format ('jpg','jpeg')<br /> * Max upload 100 MB</small></td>
                       <td>
                           <input type="file" onchange="getupload('sp');"  id="txtfsp" name="txtfsp[]" multiple>
                           <input type="hidden" id="jmlfile_sp" value="0" /><br />
