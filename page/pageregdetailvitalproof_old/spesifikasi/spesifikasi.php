  ...
  <section class="content-header">
      <h4>
        Detail <b class="text-blue">Spesifikasi Teknis</b> Dokumen Vital
      </h4>
              ...
              <form role="form" name="mymetadata" id="mymetadata" method="post" enctype="multipart/form-data" >
                 ...
                 <table class="table" border="0">
                    <tr>
                       ...
                       <td>
                           <input type="file" onchange="getupload('st');"  id="txtfst" name="txtfst">
                           <input type="hidden" id="jmlfile_st" value="0" /><br />
